...
class EntityA:
    ...
    def output(self, message):
        if len(self.q) < self.size:
            self.q.append(Pkt(self.next_seqnum, self.next_seqnum, calculate_checksum(self.next_seqnum, self.next_seqnum, message.data), message.data))
    ...
    def input(self, packet):
        ...
        i = self.base
        found = False
        while i != self.next_seqnum and not found:
            if i == packet.acknum:
                found = True

            i = (i + 1) % self.seqnum_limit
        ...
        #    print("Entity A: Duplicate Ack", packet.acknum)
        #    return
        ...
        while self.q and self.q[0].seqnum != i:
            self.q.popleft()
